...
import org.gms.extension.api.HostCharacterMetadataCallback;
...
public final class BeiDouHostCharacterProvisioner implements HostCharacterProvisioner {
    ...
    public HostCharacterProvisionResult provision(
        ...
        Objects.requireNonNull(metadataCallback, "metadataCallback");
        ...
        Provisioned provisioned = transactions.execute(connection -> {
            ...
            HostCharacterProvisionMetadata metadata = new HostCharacterProvisionMetadata(
                    character.getId(),
                    accountId,
                    request.accountName(),
                    request.characterName(),
                    request.worldId());
            metadataCallback.persist(connection, metadata);
